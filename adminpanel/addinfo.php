...
$save_data="INSERT INTO addinfo(hostel_name,no_rooms,hostel_area,details,hostel_id)VALUES('$hostel_name','$no_rooms','$hostel_area','$details','$hostel_id')";
                    ...
                    <form method='POST' action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input id="Hostel Name" name="hostel_name" placeholder="Hostel Name" class="form-control" type="text">
                            </div>
                            <div class="form-group col-md-6">
                                <input id="No.Rooms" name="hostel_id" placeholder="hostel_Id" class="form-control" required="required" type="number">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input id="No.Rooms" name="no_rooms" placeholder="No.Rooms" class="form-control" required="required" type="number">
                            </div>
                           <div class="form-group col-md-6">
                                <input id="Hostel Area" name="hostel_area" placeholder="Hostel Area" class="form-control" type="text">
                            </div>
                            <div class="form-group col-md-12">
                                <textarea id="details" name="details" placeholder="Enter Details" cols="40" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-row">

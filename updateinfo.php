...
<?php 
   $myiid = $_REQUEST['myid'];
   $selecteddataquery = "Select * from addinfo where id=$myiid";
   $selecteddata = mysqli_query($conn, $selecteddataquery);
   $cc = mysqli_num_rows($selecteddata);
   $dd = mysqli_fetch_array($selecteddata);
                ...
                <div class="col-md-4 py-5 bg-primary text-white text-center ">
                    <div class=" ">
                        <div class="card-body">
                            ...
                            <h2 class="py-3">Updated Information</h2>
                    ...
                    <form method='POST' action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input id="Hostel Name" name="hostel_name" placeholder="Hostel Name" class="form-control"  required="text" type="text" value="<?php 
                                 echo $dd[1] ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <input id="hostelid" name="hostel_id" placeholder="hostel_Id" class="form-control" required="required" type="number" min="1" value="<?php 
                                 echo $dd[5]
                                ?>">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input id="No.Rooms" name="no_rooms" placeholder="No.Rooms" class="form-control" required="required" type="number" min="1" value="<?php 
                                 echo $dd[2]
                                ?>">
                            </div>
                           <div class="form-group col-md-6">
                                <input id="Hostel Area" name="hostel_area" placeholder="Hostel Area" class="form-control" type="text"  required="required" value="<?php 
                                 echo $dd[3]
                                ?>">
                            </div>
                            <div class="form-group col-md-12">
                                <textarea id="details" name="details" placeholder="Enter Details" cols="40" rows="5" class="form-control"  required="required" value="<?php 
                                 echo $dd[4]
                                ?>"></textarea>
                            </div>
                        </div>

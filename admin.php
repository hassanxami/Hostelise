...
<body>
	...
	<div class="ws_images"><ul>
		    ...
		    <li><img src="img/intro-carousel/2.jpg" alt="about-mission" title="" id="wows0_1"/></li>
		    <li><a href="http://wowslider.net"><img src="img/intro-carousel/3.jpg" alt="javascript slider" title="" id="wows0_2"/></a></li>
	</ul></div>
	<div class="ws_bullets"><div>
		<a href="#" title=""><span><img src="data0/tooltips/aboutmission.jpg" alt="about-mission"/>2</span></a>
		<a href="#" title=""><span><img src="data0/tooltips/aboutplan.jpg" alt="about-plan"/>3</span></a>
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item drop-link">
                        ...
                        <ul>
                            ...
                            <li><a href="searchinfo.php"><i class="fas fa-search-plus" style="font-size:15px;"></i>Hostel Data</a></li>
                        </ul>
                    </li>
                    <li><a href="index.php"><i class="fas fa-sign-out-alt" style="font-size:20px;"></i> LogOut</a></li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Lahore, Punjab<br>
              Pakistan <br>
              <strong>Phone:</strong> +92 000 000 0000<br>
              <strong>Email:</strong> aaaaa@gmail.com <br>
            </p>
